...
namespace Cadastro.Services
{
    public class ProductViewModelService : IProductViewModelService
    {
        ...
        public ProductViewModels Get(int id)
        {
            ...
            return _mapper.Map<ProductViewModels>(entity);
        }

        public IEnumerable<ProductViewModels> GetAll()
        {
            var list = _productRepository.GetAll();
            if (list == null)
                return new ProductViewModels[] { };

            return _mapper.Map<IEnumerable<ProductViewModels>>(list);
        }

        public void Insert(ProductViewModels viewModel)
        {
        ...
        public void Update(ProductViewModels viewModel)
        {
            var entity = _mapper.Map<Product>(viewModel);
